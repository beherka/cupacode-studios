-- =====================================================
-- SETUP COMPLET — Cupacode Studios
-- Un seul copier-coller dans Supabase SQL Editor
-- =====================================================
...
UPDATE public.projects SET external_url = 'https://deal-trainer.com'   WHERE slug = 'deal-trainer';
